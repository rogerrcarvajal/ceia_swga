                    ...
                    <?php foreach ($profesores as $p): ?>
                        <li>
                            ...
                            <div>
                                ...
                                <a href="eliminar_profesor.php?id=<?= $p['id'] ?>" onclick="return confirm('¿Estás seguro de eliminar a este miembro del staff? Se eliminarán todas sus asignaciones en todos los períodos escolares.')">Eliminar</a>
                            </div>
                        </li>
                    <?php endforeach; ?>
                <?php endif; ?>
