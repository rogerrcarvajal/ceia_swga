...
if (!isset($_SESSION['usuario']['rol']) || !in_array($_SESSION['usuario']['rol'], ['master','admin'])) {
    ...
    echo '<script>window.onload = function() { alert("Acceso denegado. Solo usuarios autorizados tienen acceso a éste moódulo."); window.location.href = "/ceia_swga/pages/dashboard.php"; };</script>';
    exit();
}
