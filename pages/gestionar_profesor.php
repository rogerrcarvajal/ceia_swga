...
if (!isset($_SESSION['usuario']['rol']) || !in_array($_SESSION['usuario']['rol'], ['master','admin'])) {
    $_SESSION['error_acceso'] = "Acceso denegado. Solo el Usuario Master y Admin pueden gestionar el módulo de profesores.";
    echo '<script>window.onload = function() { alert("Acceso denegado. Solo el Usuario Master y Admin pueden gestionar el módulo de profesores."); window.location.href = "/ceia_swga/pages/dashboard.php"; };</script>';
    exit();
}
...
$posiciones = ["Director", "Bussiness Manager", "Administrative Assistant", "IT Manager", "Maintenance Coordinator", "Psychology", "Daycare, Pk-3", "Daycare, Pk-3 (Asist.)", "Pk-4, Kindergarten", "Pk-4, Kindergarten (Asist.)", "Grade 1", "Grade 2", "Grade 3", "Grade 4", "Grade 5", "Grade 6", "Grade 7", "Grade 8", "Grade 9", "Grade 10", "Grade 11", "Grade 12", "Spanish teacher - Grade 1-6", "Spanish teacher - Grade 7-12", "Social Studies - Grade 6-12", "IT Teacher - Grade Pk-3-12", "Science Teacher - Grade 6-12", "ESL - Elementary", "ESL - Secondary", "PE - Grade Pk3-12", "Language Arts - Grade 6-9", "Math teacher - Grade 6-9", "Math teacher - Grade 10-12", "Librarian" , "Art Teacher - Grade Pk3-12", "Music Teacher - Grade Pk3-12", "Counselor - Grade Pk3-12", "Substitute Teacher", "Mantenimiento", "Vigilancia", "Chofer","Otro"];
...
<head>
    ...
    <style>
       body { margin: 0; padding: 0; background-image: url("/ceia_swga/public/img/fondo.jpg"); background-size: cover; background-position: top; font-family: 'Arial', sans-serif; color: white;}
        ...
        .content { text-align: center; margin-top: 30px; text-shadow: 1px 1px 2px black; }
