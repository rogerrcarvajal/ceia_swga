...
$periodos_stmt = $conn->query("SELECT id, nombre_periodo FROM periodos_escolares ORDER BY nombre_periodo DESC");
...
<body>
    ...
    <div class="content">
        ...
        <h1>Asignar Estudiantes a Período Escolar</h1>
    ...
    <div class="main-container">
        <div class="left-panel">
            ...
            <ul id="lista_estudiantes_asignados">
                </ul>
        </div>

        <div class="right-panel">
            <div id="panel_informativo"><p>Seleccione un período para ver los estudiantes o asignar nuevos.</p></div>

            <div id="panel_asignacion" style="display:none;">
                <h3>Asignar Nuevo Estudiante a este Período</h3>
                <form id="form_asignar_estudiante">
                    ...
                    <label for="grado_asignar">Grado a cursar:</label>
                    <select name="grado_asignar" id="grado_asignar" required>
    ...
    <script src="/public/js/asignar_estudiante_periodo.js"></script>
</body>
</html>