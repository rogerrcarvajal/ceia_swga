...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(80);
        $this->Cell(110, 10, 'Reporte de Estudiantes', 0, 0, 'C');
        $this->Ln(5);
        $this->SetFont('Arial', '', 10);
        $this->Cell(80);
        $this->Cell(110, 10, 'Periodo Activo: ' . $this->periodo_nombre, 0, 0, 'C');
        $this->Ln(20);
    }
...
$pdf->Cell(25, 7, 'Grado', 1);
$pdf->Cell(60, 7, 'Padre / Madre', 1);
$pdf->Cell(40, 7, 'Teléfonos', 1);
$pdf->Cell(70, 7, 'Email', 1);
$pdf->Ln();
...
$nombre_archivo = "lista_estudiantes_" . str_replace(' ', '_', $periodo_activo['nombre_periodo']) . ".pdf";
