...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(80);
        $this->Cell(30, 10, utf8_decode('Reporte de Staff Vigilancia'), 0, 0, 'C');
        $this->Ln(5);
...
$nombre_archivo = "lista_staff_vigilancia_" . str_replace(' ', '_', utf8_decode($periodo_activo['nombre_periodo'])) . ".pdf";
