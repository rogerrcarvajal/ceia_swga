...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(80);
        $this->Cell(30, 10, utf8_decode('Reporte de Staff Docente'), 0, 0, 'C');
        $this->Ln(5);
...
<<<<<<< HEAD
$nombre_archivo = "lista_staff_docente_" . sanitize_filename($periodo_activo['nombre_periodo']) . ".pdf";
=======
$nombre_archivo = "lista_staff_docente_" . str_replace(' ', '_', utf8_decode($periodo_activo['nombre_periodo'])) . ".pdf";
>>>>>>> 8d1a461c063b6cdee4cbf4e0693b92c4894df3ad
